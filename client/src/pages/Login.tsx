    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                toast.success("Welcome back to CodeLink");
                navigate("/");
            } else {
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-4 z-10">
                <div className="w-full max-w-sm">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold tracking-tight mb-2 text-zinc-900 dark:text-white">Welcome Back</h1>
                        <p className="text-zinc-550 dark:text-zinc-400 text-sm">Enter your credentials to access your workspace</p>
                    </div>
                    ...
                    <div className="bg-white/40 dark:bg-zinc-900/40 backdrop-blur-xl border border-zinc-200/80 dark:border-white/5 rounded-2xl p-6 md:p-8 shadow-2xl transition-colors">
                        ...
                        <div className="mt-6 pt-6 border-t border-zinc-200 dark:border-zinc-800/50 text-center">
                            <p className="text-sm text-zinc-500 dark:text-zinc-400">
                                ...
                                <Link to="/register" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 font-semibold transition-colors">
                                    Sign up
                                </Link>
                            </p>
                        </div>
